<script lang='ts'>
  ...
  import type { SignupSchema } from '../../../routes/(auth)/signup/schema'
  ...
  import { signupSchema } from '../../../routes/(auth)/signup/schema'
          ...
          <Form.Field {form} name='email'>
            <Form.Control>
              {#snippet children({ props })}
                ...
                <Input type='email' placeholder='m@example.com' {...props} bind:value={$formData.email} />
              {/snippet}
            </Form.Control>
            <Form.FieldErrors />
          </Form.Field>
          ...
          <Form.Field {form} name='confirmPassword'>
            <Form.Control>
              {#snippet children({ props })}
                ...
                <Input type='password' placeholder='********' {...props} bind:value={$formData.confirmPassword} />
              {/snippet}
            </Form.Control>
            <Form.FieldErrors />
          </Form.Field>
